...
Then build the index of the assembly:
    ...
    sailfish index -t Trinity_cap3_uclust_clean.fasta -o sailfish-index-Trinity_cap3_uclust -k 20 -p 4
...
Make a directory for the expression values
    ...
    mkdir sailfish-expression-Trinity-cap3-uclust
...
sfindex <- "results/trinity-full/sailfish-index-Trinity_cap3_uclust"
...
png(file=paste(resultsdir, "pval_hist.png"))
par(mfrow = c(2,1))
hist(RxNpval$pval)
hist(RxNpval$padj)
dev.off()
...
png(file = paste(resultsdir, "responsive_transcripts_mosaicplot.png", sep = ""))
mosaicplot(tt2, shade = TRUE, xlab = "ApVT", ylab = "AcNC", main = "Mosaic plot of responsive transcripts")
dev.off()
