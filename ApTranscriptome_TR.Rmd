...
testset <- responsive.transcripts[1:10]
varshape.out <- ldply(responsive.transcripts, .progress = "text", RxNvarshape)

# to compare among transcripts, standardize by overall mean for each transcript


# t test
t.test(varshape.out$A22.mean, varshape.out$Ar.mean)
