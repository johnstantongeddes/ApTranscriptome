...
# calculate response type for transcripts with interactions
...
transcriptVar <- function(lmitem, colony) {
...
A22.int.sd <- unlist(Map(transcriptVar, A22.int.lm, colony = "A22"))

# repeat for Ar
Ar.int.lm <- RxNlmAIC[Ar.int.transcripts$Transcript]
Ar.int.sd <- unlist(Map(transcriptVar, Ar.int.lm, colony = "Ar"))
