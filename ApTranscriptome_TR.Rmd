...
test.transcripts <- interaction.transcripts[1000:1009]
response.type <- ldply(test.transcripts, .progress = "text", .inform = TRUE, RxNtype)




# plot
qplot(val, pTPM, facets = .~colony, data = Ar.pout, geom="smooth")
