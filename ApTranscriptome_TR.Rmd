...
A22.geneList.high[(which(names(A22.geneList.high) %in% A22.only.high))] <- 1
...
tail(A22.high.geneList.refseq.id)

# add genelist to DAVID
david.geneList <- addList(david.connect, A22.high.geneList.refseq.id,
                      idType = "REFSEQ_PROTEIN",
