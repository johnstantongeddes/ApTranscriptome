...
david.list <- addList(david.connect, refseq.id,
...
david.list <- addList(david.connect, A22.high.geneList.refseq.id,
                      idType = "REFSEQ_PROTEIN",
