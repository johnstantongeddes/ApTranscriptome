...
# plot
T_on_plot_high <- ggplot(Ap.high.T_on, aes(x = T_on, y = ..density.., colour = colony, group = colony, fill = colony)) +
...
print(T_on_plot_high)

# plot predicted
pT_on_plot_high <- ggplot(Ap.high.T_on, aes(x = pT_on, y = ..density.., colour = colony, group = colony, fill = colony)) +
    geom_histogram(position = "dodge", binwidth = 3) +
    geom_density(adjust = 3, fill = NA, size = 2) + 
    scale_y_continuous(name="Density") +
    scale_x_continuous(name=expression("Temperature"))
print(pT_on_plot_high)
```
...
# plot
T_on_plot_low <- ggplot(Ap.low.T_on, aes(x = T_on, y = ..density.., colour = colony, group = colony, fill = colony)) +
    geom_histogram(position = "dodge", binwidth = 3) +
    geom_density(adjust = 3, fill = NA, size = 2) + 
    scale_y_continuous(name="Density") +
    scale_x_continuous(name=expression("Temperature"))
...
# plot
pT_on_plot_low <- ggplot(Ap.low.T_on, aes(x = pT_on, y = ..density.., colour = colony, group = colony, fill = colony)) +
    geom_histogram(position = "dodge", binwidth = 3) +
    geom_density(adjust = 3, fill = NA, size = 2) + 
    scale_y_continuous(name="Density") +
    scale_x_continuous(name=expression("Temperature"))
print(pT_on_plot_low)
```
