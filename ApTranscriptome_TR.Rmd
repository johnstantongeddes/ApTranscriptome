...
# low plot
png("T_on_low.png")
T_on_low_plot <- ggplot(rbind(A22.low.T_on, Ar.low.T_on), aes(x = T_on, y = ..density.., colour = colony, group = colony, fill = colony)) +
...
# high plot
png("T_on_high.png")
T_on_high_plot <- ggplot(rbind(A22.high.T_on, Ar.high.T_on), aes(x = T_on, y = ..density.., colour = colony, group = colony, fill = colony)) +
    geom_histogram(position = "dodge", binwidth = 3) +
    geom_density(adjust = 3, fill = NA, size = 2) +
    labs(x = "Temperature of gene activation", y = "Density") +
    theme(axis.title = element_text(size = rel(2))) +
...
```{r gsea_setdiff_table, echo = FALSE, results = 'asis', eval = FALSE}
