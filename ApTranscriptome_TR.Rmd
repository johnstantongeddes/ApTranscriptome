...
pandoc.table(Ap.type.table, style="rmarkdown", caption = "Number of thermally-responsive transcripts with maximum expression at high, low, intermediate, both high and low (bimodal) temperatures or are not expressed for each colony.")
