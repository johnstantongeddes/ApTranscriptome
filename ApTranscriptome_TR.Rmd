...
Genes with increased expression at *High* temperatures are on average turned on 2.5°C higher in *ApVT* than *AcNC*.
...
#    if(min(s[which(s$val < 30) , pTPM]) < s[which(s$val == 38.5), pTPM] & s[which(s$val == 0), pTPM] < (s[which(s$val == 21), pTPM] + sd(s$pTPM))) print("On low") else {
