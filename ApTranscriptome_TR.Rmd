...
enhanced_response_dat[which(enhanced_response_dat$Acar == "Low"), "value"] <- runif(5, min = -100, max = -150)
enhanced_response_dat[which(enhanced_response_dat$Acar == "Bimodal"), "value"] <- runif(5, min = -100, max = -150)
# change shared response to positive
enhanced_response_dat[which(enhanced_response_dat$Acar == "Low" & enhanced_response_dat$Apic == "Low"), "value"] <- 10
enhanced_response_dat[which(enhanced_response_dat$Acar == "Bimodal" & enhanced_response_dat$Apic == "Bimodal"), "value"] <- 10
...
tolerance_dat[which(tolerance_dat$Acar == "Low"), "value"] <- runif(5, min = 250, max = 300)
tolerance_dat[which(tolerance_dat$Acar == "Bimodal"), "value"] <- runif(5, min = 250, max = 300)
# change shared response to near zero
tolerance_dat[which(tolerance_dat$Acar == "Low" & tolerance_dat$Apic == "Low"), "value"] <- -100
tolerance_dat[which(tolerance_dat$Acar == "Bimodal" & tolerance_dat$Apic == "Bimodal"), "value"] <- -100
