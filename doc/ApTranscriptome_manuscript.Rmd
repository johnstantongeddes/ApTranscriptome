...
All analyses were performed with R 3.2 [@r_core_team2013] and are fully reproducible (Supporting Information).
...
The Trinity transcriptome assembly, FastAnnotator annotation file and Sailfish gene expression quantification files supporting the results of this article are available at the Harvard Forest Archives, HF-113 (http://harvardforest.fas.harvard.edu/data-archive) datasets hf113-38, hf113-39, and hf113-40 (doi:10.6073/pasta/050a6c7c2ff25841b070a0ecab32bc65). 

The reproducible and version-controlled scripts for data analysis are available on GitHub (https://github.com/johnstantongeddes/ApTranscriptome). 
