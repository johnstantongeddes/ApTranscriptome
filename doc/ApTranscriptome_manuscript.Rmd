...
Table S1 contains the results of the gene set enrichment analysis, showing the enriched gene ontology terms for each species in each thermal response category.
