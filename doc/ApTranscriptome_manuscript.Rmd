...
We performed a number of additional comparisons to evaluate the extent to which the thermal reactionomes differed between *A. carolinensis* and *A. picea*. First, we found that the profile of the temperature of maximum expression for the thermally-responsive genes differed between species (Figure 3) with a similar number of genes at high temperatures, more genes at intermediate temperatures in *A. carolinensis* and more genes at low temperatures in *A. picea*. 
