...
To summarise, in this project we generated the transcriptomes of two closely-related temperate ant species, and quantified their gene expression across a wide range of thermal conditions. We used a reactionome approach to identify all transcripts that changed expression across a thermal gradient each species. We then evaluated three non-mutually exclusive hypotheses (enhanced response, tolerance and genetic assimilation) of the evolution of thermal adaptation by comparing differences between the thermal reactionomes of each species. Finally, we used gene ontology information to determine which gene products and pathways are involved in thermal adaptation in the two species.
...
The Trinity transcriptome assembly, FastAnnotator annotation file and Sailfish gene expression quantification files supporting the results of this article are available at the Harvard Forest Archives, HF-113 (http://harvardforest.fas.harvard.edu/data-archive) datasets hf113-38, hf113-41, and hf113-42 (doi:10.6073/pasta/050a6c7c2ff25841b070a0ecab32bc65). 
...
**Figure 1**. Illustration of the patterns against temperature for each of the four expression categories, **Bimodal**, **High**, **Intermediate** and **Low**. The fifth category of **Not Responsive** is not shown as these transcripts would be a line with no clear pattern.
